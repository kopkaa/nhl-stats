  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 flex flex-col gap-5">
      ...
      <div v-if="topForwards.length">
        <h3 class="text-[0.7rem] font-semibold text-gray-500 uppercase tracking-widest mb-3">Top Forwards</h3>
        <div class="flex flex-col gap-1">
          ...
          >
            <span class="text-[0.65rem] text-gray-600 w-4 tabular-nums text-right">{{ index + 1 }}</span>
            <img
            ...
            <div class="flex-1 min-w-0">
              ...
              <span class="text-gray-600 text-xs ml-1.5">{{ forward.positionCode }}</span>
            </div>
            <div class="flex items-center gap-4 tabular-nums text-xs">
              <div class="text-center">
                <div class="text-white font-bold text-sm">{{ forward.points }}</div>
                <div class="text-gray-600 text-[0.6rem]">PTS</div>
              </div>
              <div class="text-center">
                <div class="text-gray-300">{{ forward.goals }}</div>
                <div class="text-gray-600 text-[0.6rem]">G</div>
              </div>
              <div class="text-center">
                <div class="text-gray-300">{{ forward.assists }}</div>
                <div class="text-gray-600 text-[0.6rem]">A</div>
              </div>
              <div class="text-center">
                <div class="text-gray-400">{{ forward.gamesPlayed }}</div>
                <div class="text-gray-600 text-[0.6rem]">GP</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div v-if="topDefensemen.length">
        <h3 class="text-[0.7rem] font-semibold text-gray-500 uppercase tracking-widest mb-3">Top Defensemen</h3>
        <div class="flex flex-col gap-1">
          <div
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              ...
              <span class="text-gray-600 text-xs ml-1.5">D</span>
            </div>
            <div class="flex items-center gap-4 tabular-nums text-xs">
              <div class="text-center">
                <div class="text-white font-bold text-sm">{{ defenseman.points }}</div>
                <div class="text-gray-600 text-[0.6rem]">PTS</div>
              </div>
              <div class="text-center">
                <div class="text-gray-300">{{ defenseman.goals }}</div>
                <div class="text-gray-600 text-[0.6rem]">G</div>
              </div>
              <div class="text-center">
                <div class="text-gray-300">{{ defenseman.assists }}</div>
                <div class="text-gray-600 text-[0.6rem]">A</div>
              </div>
              <div class="text-center">
                <div class="text-gray-400">{{ defenseman.gamesPlayed }}</div>
                <div class="text-gray-600 text-[0.6rem]">GP</div>
              </div>
            </div>
          </div>
      ...
      <!-- Top Goalie -->
      <div v-if="topGoalie">
        <h3 class="text-[0.7rem] font-semibold text-gray-500 uppercase tracking-widest mb-3">Starting Goalie</h3>
        <div class="flex items-center gap-3 px-3 py-3 rounded-lg bg-white/[0.04]">
          ...
          <div class="flex items-center gap-5 tabular-nums text-xs">
            <div class="text-center">
              <div class="text-white font-bold text-sm">{{ topGoalie.savePctg ? `.${(topGoalie.savePctg * 1000).toFixed(0)}` : '—' }}</div>
              <div class="text-gray-600 text-[0.6rem]">SV%</div>
            </div>
            <div class="text-center">
              <div class="text-gray-300">{{ topGoalie.goalsAgainstAvg?.toFixed(2) ?? '—' }}</div>
              <div class="text-gray-600 text-[0.6rem]">GAA</div>
            </div>
            <div class="text-center">
              <div class="text-gray-300">{{ topGoalie.wins }}-{{ topGoalie.losses }}-{{ topGoalie.otLosses }}</div>
              <div class="text-gray-600 text-[0.6rem]">W-L-OTL</div>
            </div>
            <div class="text-center">
              <div class="text-gray-400">{{ topGoalie.shutouts }}</div>
              <div class="text-gray-600 text-[0.6rem]">SO</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="flex flex-col gap-5">
      ...
      <div v-if="recentGames.length">
        <h3 class="text-[0.7rem] font-semibold text-gray-500 uppercase tracking-widest mb-3">Last {{ recentGames.length }}</h3>
      ...
      <div v-if="upcomingGames.length">
        <h3 class="text-[0.7rem] font-semibold text-gray-500 uppercase tracking-widest mb-3">Next {{ upcomingGames.length }}</h3>
        <div class="flex flex-col gap-1.5">
          <div
